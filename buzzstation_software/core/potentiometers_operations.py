...
def pots_operations(data_for_thread):
    ...
    while True:
        ...
        bpm_new_value = int(potentiometer_values_transform.bpm_from_potentiometer2(pots_values[1]))
        ...
        swing_new_value = int(potentiometer_values_transform.swing_from_potentiometer1(pots_values[2]))
